...
type VirtualNetworkFunctionsIface interface {
...
func (s *VirtualNetworkFunctions) NewDeleteVnfTemplateParams(id string) *DeleteVnfTemplateParams {
...
func (s *VirtualNetworkFunctions) DeleteVnfTemplate(p *DeleteVnfTemplateParams) (*DeleteVnfTemplateResponse, error) {
...
// as then you are sure you have configured all required params
func (s *VirtualNetworkFunctions) NewDeployVnfApplianceParams(serviceofferingid string, templateid string, zoneid string) *DeployVnfApplianceParams {
...
func (s *VirtualNetworkFunctions) DeployVnfAppliance(p *DeployVnfApplianceParams) (*DeployVnfApplianceResponse, error) {
...
// as then you are sure you have configured all required params
func (s *VirtualNetworkFunctions) NewListVnfTemplatesParams(templatefilter string) *ListVnfTemplatesParams {
...
func (s *VirtualNetworkFunctions) GetVnfTemplateID(name string, templatefilter string, opts ...OptionFunc) (string, int, error) {
	p := &ListVnfTemplatesParams{}
	p.p = make(map[string]interface{})
...
// This is a courtesy helper function, which in some cases may not work as expected!
func (s *VirtualNetworkFunctions) GetVnfTemplateByName(name string, templatefilter string, opts ...OptionFunc) (*VnfTemplate, int, error) {
...
// This is a courtesy helper function, which in some cases may not work as expected!
func (s *VirtualNetworkFunctions) GetVnfTemplateByID(id string, templatefilter string, opts ...OptionFunc) (*VnfTemplate, int, error) {
	p := &ListVnfTemplatesParams{}
	p.p = make(map[string]interface{})
...
func (s *VirtualNetworkFunctions) ListVnfTemplates(p *ListVnfTemplatesParams) (*ListVnfTemplatesResponse, error) {
...
// as then you are sure you have configured all required params
func (s *VirtualNetworkFunctions) NewRegisterVnfTemplateParams(format string, hypervisor string, name string, url string) *RegisterVnfTemplateParams {
...
func (s *VirtualNetworkFunctions) RegisterVnfTemplate(p *RegisterVnfTemplateParams) (*RegisterVnfTemplateResponse, error) {
...
// as then you are sure you have configured all required params
func (s *VirtualNetworkFunctions) NewUpdateVnfTemplateParams(id string) *UpdateVnfTemplateParams {
...
func (s *VirtualNetworkFunctions) UpdateVnfTemplate(p *UpdateVnfTemplateParams) (*UpdateVnfTemplateResponse, error) {
