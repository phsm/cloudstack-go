...
func (m *MockImageStoreServiceIface) NewUpdateImageStoreParams(id string) *UpdateImageStoreParams {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewUpdateImageStoreParams", id)
	ret0, _ := ret[0].(*UpdateImageStoreParams)
	return ret0
}

// NewUpdateImageStoreParams indicates an expected call of NewUpdateImageStoreParams.
func (mr *MockImageStoreServiceIfaceMockRecorder) NewUpdateImageStoreParams(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewUpdateImageStoreParams", reflect.TypeOf((*MockImageStoreServiceIface)(nil).NewUpdateImageStoreParams), id)
}
