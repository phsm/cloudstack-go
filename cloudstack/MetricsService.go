...
// as then you are sure you have configured all required params
func (s *MetricsService) NewListManagementServersParams() *ListManagementServersParams {
...
func (s *MetricsService) GetManagementServerID(name string, opts ...OptionFunc) (string, int, error) {
	p := &ListManagementServersParams{}
	p.p = make(map[string]interface{})
...
// This is a courtesy helper function, which in some cases may not work as expected!
func (s *MetricsService) GetManagementServerByName(name string, opts ...OptionFunc) (*ManagementServer, int, error) {
...
// This is a courtesy helper function, which in some cases may not work as expected!
func (s *MetricsService) GetManagementServerByID(id string, opts ...OptionFunc) (*ManagementServer, int, error) {
	p := &ListManagementServersParams{}
	p.p = make(map[string]interface{})
...
func (s *MetricsService) ListManagementServers(p *ListManagementServersParams) (*ListManagementServersResponse, error) {
