...
// DisableHAForHost mocks base method.
func (m *MockHostServiceIface) DisableHAForHost(p *DisableHAForHostParams) (*DisableHAForHostResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DisableHAForHost", p)
	ret0, _ := ret[0].(*DisableHAForHostResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DisableHAForHost indicates an expected call of DisableHAForHost.
func (mr *MockHostServiceIfaceMockRecorder) DisableHAForHost(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DisableHAForHost", reflect.TypeOf((*MockHostServiceIface)(nil).DisableHAForHost), p)
}
...
// MigrateResourceToAnotherSecondaryStorage mocks base method.
func (m *MockHostServiceIface) MigrateResourceToAnotherSecondaryStorage(p *MigrateResourceToAnotherSecondaryStorageParams) (*MigrateResourceToAnotherSecondaryStorageResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MigrateResourceToAnotherSecondaryStorage", p)
	ret0, _ := ret[0].(*MigrateResourceToAnotherSecondaryStorageResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// MigrateResourceToAnotherSecondaryStorage indicates an expected call of MigrateResourceToAnotherSecondaryStorage.
func (mr *MockHostServiceIfaceMockRecorder) MigrateResourceToAnotherSecondaryStorage(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MigrateResourceToAnotherSecondaryStorage", reflect.TypeOf((*MockHostServiceIface)(nil).MigrateResourceToAnotherSecondaryStorage), p)
}
...
// NewDisableHAForHostParams mocks base method.
func (m *MockHostServiceIface) NewDisableHAForHostParams(hostid string) *DisableHAForHostParams {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewDisableHAForHostParams", hostid)
	ret0, _ := ret[0].(*DisableHAForHostParams)
	return ret0
}

// NewDisableHAForHostParams indicates an expected call of NewDisableHAForHostParams.
func (mr *MockHostServiceIfaceMockRecorder) NewDisableHAForHostParams(hostid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewDisableHAForHostParams", reflect.TypeOf((*MockHostServiceIface)(nil).NewDisableHAForHostParams), hostid)
}
...
// NewMigrateResourceToAnotherSecondaryStorageParams mocks base method.
func (m *MockHostServiceIface) NewMigrateResourceToAnotherSecondaryStorageParams(destpool, srcpool string) *MigrateResourceToAnotherSecondaryStorageParams {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewMigrateResourceToAnotherSecondaryStorageParams", destpool, srcpool)
	ret0, _ := ret[0].(*MigrateResourceToAnotherSecondaryStorageParams)
	return ret0
}

// NewMigrateResourceToAnotherSecondaryStorageParams indicates an expected call of NewMigrateResourceToAnotherSecondaryStorageParams.
func (mr *MockHostServiceIfaceMockRecorder) NewMigrateResourceToAnotherSecondaryStorageParams(destpool, srcpool interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewMigrateResourceToAnotherSecondaryStorageParams", reflect.TypeOf((*MockHostServiceIface)(nil).NewMigrateResourceToAnotherSecondaryStorageParams), destpool, srcpool)
}
