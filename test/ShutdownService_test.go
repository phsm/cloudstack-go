...
func TestShutdownService(t *testing.T) {
	...
	testcancelShutdown := func(t *testing.T) {
		...
		p := client.Shutdown.NewCancelShutdownParams("managementserverid")
		_, err := client.Shutdown.CancelShutdown(p)
		if err != nil {
			t.Errorf(err.Error())
		}
	}
	...
	testprepareForShutdown := func(t *testing.T) {
		...
		p := client.Shutdown.NewPrepareForShutdownParams("managementserverid")
		_, err := client.Shutdown.PrepareForShutdown(p)
		if err != nil {
			t.Errorf(err.Error())
		}
	}
	...
	testtriggerShutdown := func(t *testing.T) {
		...
		p := client.Shutdown.NewTriggerShutdownParams("managementserverid")
		_, err := client.Shutdown.TriggerShutdown(p)
		if err != nil {
			t.Errorf(err.Error())
		}
	}
